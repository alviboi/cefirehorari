...
<body>
    ...
    @if ($dat['estat'] == 'Eliminada')
        <h2>A no ser que hages eliminat tú el dia, qualsevol aclariment que vullgues fer has de dirigir-te a
            l'adminsitrador.</h2>
    @else
        <h2>Una vegada Aprovat el dia, si finalment l'elimines cal que avises a l'administrador'.</h2>
    @endif
    <br><br>
