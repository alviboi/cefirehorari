            ...
            <div class="uk-cover-container uk-flex uk-flex-middle">
                <div class="uk-container uk-flex-auto uk-position-relative uk-margin uk-margin-large-top uk-margin-large-bottom" data-uk-parallax="y: 0,99; easing:0; opacity:0.0">
                    <div class="uk-width-1-2@s" data-uk-scrollspy="cls: uk-animation-slide-right-medium; target: > *; delay: 150">
                        ...
                        <h1 class="uk-margin-remove-top">Intranet del Servei de formació del professorat</h1>
                        <p class="subtitle-text uk-visible@s">Aquesta pàgina és per a gestionar els horaris del Servei de formació. A continuació teniu els enllaços per a accedir a diferents recursos.</p>
                    </div>
                </div>
...
<div class="uk-grid-column-small uk-grid-row-large uk-child-width-1-3@s uk-text-center uk-grid-match enlla" uk-grid>
    ...
    <div>
        <div class="buttons2">
                <div class="container2">
                    <a href="https://ceice.gva.es/va/web/formacion-profesorado" class="btn2 effect04" data-sm-link-text="Pàgina del servei" target="_blank"><span class="uk-flex uk-flex-middle"><i class="fa fa-file fa-3x" aria-hidden="true"></i> Pàgina del servei</span></a>
                </div>
            </div>
    </div>
    {{-- <div>
